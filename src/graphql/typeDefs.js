...
const typeDefs = gql`
  directive @unique(
    "The resource path name for the rest endpoint"
    path: String!
    """
  ...
  """
  An author is a person who wrote one or two books.
  """
  ...
  """
  List of author results with pagination information.
  """
  type Authors {
  ...
  """
  A written work that can be attributed to one or more authors and can
  ...
  type Book {
    ...
    Default sord order is REVIEWED_ON_DESC
    """
    reviews(limit: Int = 10, orderBy: ReviewOrderBy, page: Int): Reviews
  ...
  input CreateBookAndAuthorsInput {
    ...
    authorNames: [String]
    "The URL of the book's cover page."
    cover: String
    "A literary genre to which the book can be assigned."
    genre: Genre
    "A short summary of the book's content."
